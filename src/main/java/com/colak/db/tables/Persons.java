 ...
 */
package com.colak.db.tables;


import com.colak.db.Keys;
import com.colak.db.Userdb;
...
public class Persons extends TableImpl<PersonsRecord> {
    ...
    /**
     * The reference instance of <code>userdb.persons</code>
     */
    ...
    /**
     * The column <code>userdb.persons.person_key</code>.
     */
    public final TableField<PersonsRecord, Long> PERSON_KEY = createField(DSL.name("person_key"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>userdb.persons.name</code>.
     */
    ...
    /**
     * Create an aliased <code>userdb.persons</code> table reference
     */
    ...
    /**
     * Create a <code>userdb.persons</code> table reference
     */
    public Persons() {
